            ...
            public void onClick(View v) {
                if (viewModel != null) {
                    switch (radioGroup.getCheckedRadioButtonId()) {
                        case R.id.option1: {
                            viewModel.question3option.setValue(1);
                            break;
                        }
                        case R.id.option2: {
                            viewModel.question3option.setValue(2);
                            break;
                        }
                        case R.id.option3: {
                            viewModel.question3option.setValue(3);
                            break;
                        }
                        case R.id.option4: {
                            viewModel.question3option.setValue(4);
                            break;
                        }
                    }
                }
                navController.navigate(R.id.action_question3_to_question4);
            }
        });
    }
}
